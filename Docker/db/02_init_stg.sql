...
-- Dummy data to show how an article could be encoded
COPY encoded_articles.tfidf_representation FROM '/staging_data/encoded_articles.tfidf_representation.csv' WITH CSV HEADER;
